...
export default function BeefProductsPage() {
  ...
  const title = locale === "ro" ? "Carne de Vită" : "Beef";
  const subtitle =
    locale === "ro"
      ? "Descoperă gama noastră selectă de carne de vită premium"
      : "Discover our select range of premium beef products";

  // handlers pentru modal
  const openProductModal = (product: any) => {
    setSelectedProduct(product);
    // opțional: blocare scroll page
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="pt-20 sm:pt-28 pb-12">
          ...
          <div className="text-center mb-8">
            ...
            <div className="inline-block mb-6">
              <div className="relative">
                <div className="absolute inset-0 bg-red-500/20 rounded-full blur-2xl transform scale-150"></div>
          ...
          <div className="mb-16">
            ...
            <div className="text-center">
              <div className="inline-block relative">
                <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 via-red-400/20 to-red-500/10 rounded-2xl blur-xl"></div>

                <div className="relative px-8 py-4 bg-black/30 backdrop-blur-sm border border-red-500/30 rounded-2xl shadow-xl">
                  <p className="text-xl sm:text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-red-200 via-red-100 to-red-200 drop-shadow-lg leading-relaxed">
                    {subtitle}
                  </p>

                  {/* Decorative elements cu tema roșie pentru vită */}
                  <div className="absolute -top-1 -left-1 w-4 h-4 border-t-2 border-l-2 border-red-400/50 rounded-tl-lg"></div>
                  <div className="absolute -top-1 -right-1 w-4 h-4 border-t-2 border-r-2 border-red-400/50 rounded-tr-lg"></div>
                  <div className="absolute -bottom-1 -left-1 w-4 h-4 border-b-2 border-l-2 border-red-400/50 rounded-bl-lg"></div>
                  <div className="absolute -bottom-1 -right-1 w-4 h-4 border-b-2 border-r-2 border-red-400/50 rounded-br-lg"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-black/20 via-black/10 to-black/20 backdrop-blur-sm rounded-3xl border border-red-500/10"></div>

            {/* Decorative background patterns cu tema roșie */}
            <div className="absolute inset-0 opacity-5">
              <div className="absolute top-4 left-4 w-32 h-32 bg-red-400 rounded-full blur-3xl"></div>
              <div className="absolute bottom-4 right-4 w-24 h-24 bg-red-600 rounded-full blur-2xl"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-red-500 rounded-full blur-3xl"></div>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-300">
                    {locale === "ro"
                      ? "Produsele de vită vor fi adăugate în curând."
                      : "Beef products will be added soon."}
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
                  {products.map((product, index) => (
                    // înlocuit Link cu button pentru a deschide modalul în loc de navigare
                    <button
                      key={product.id}
                    ...
                    >
                      <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border-2 border-red-500/20 rounded-2xl shadow-2xl hover:shadow-red-500/40 transition-all duration-700 transform hover:scale-105 hover:-translate-y-2 overflow-hidden h-full min-h-[350px]">
                        {/* Color overlay pentru vită */}
                        <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-red-700/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        ...
                        <div className="relative z-10 p-6 h-full flex flex-col">
                          ...
                          <div className="relative mb-4 overflow-hidden rounded-xl flex-shrink-0">
                            {product.image ? (
                              ...
                              <div className="w-full h-40 bg-gradient-to-br from-red-900/20 to-red-700/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-700">
                        ...
                        {/* Border glow effect */}
                        <div className="absolute inset-0 rounded-2xl border border-red-500/0 group-hover:border-red-500/50 transition-all duration-500"></div>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              <div className="text-center">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center py-3 border-b border-yellow-500/20">
                    ...
                    <span className="text-gray-300">{locale === "ro" ? "Vita" : "Beef"}</span>
                  </div>
                </div>
