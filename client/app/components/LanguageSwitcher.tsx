...
export default function LanguageSwitcher({
  ...
  // Extrag limba curentă din pathname (folosim initialLocale pentru SSR)
  const detectedLocale = pathname ? pathname.split("/")[1] : undefined;
  const currentLocale = mounted
    ? detectedLocale
    : initialLocale || detectedLocale || "ro";
  ...
  useEffect(() => {
    // mark as mounted so we only show fully dynamic values after hydration
    setMounted(true);
  }, []);
    ...
    <div className="relative" suppressHydrationWarning>
      ...
      >
        ...
        <span className="font-medium">
          {mounted ? currentLanguage.code.toUpperCase() : "RO"}
        </span>
        <svg
