...
const categories = {
  ro: [
    { name: "Carne", link: "/ro/produse/carne-subcategorii", icon: "🥩", hasSubcategories: true },
    ...
    { name: "Condimente", link: "/ro/produse/Condimente & FRT", icon: "🧂" },
  ...
  en: [
    ...
    { name: "Potatoes", link: "/en/produse/Cartofi", icon: "🥔" },
    { name: "Dairy", link: "/en/produse/Lactate", icon: "🧀" },
    { name: "Vegetables", link: "/en/produse/Legume", icon: "🥦" },
    { name: "Canned", link: "/en/produse/Conserve", icon: "🥫" },
    { name: "Spices", link: "/en/produse/Condimente & FRT", icon: "🧂" },
    { name: "Pasta", link: "/en/produse/Paste", icon: "🍝" },
    { name: "Sauces", link: "/en/produse/Sosuri", icon: "🥗" }, 
    { name: "Specialties", link: "/en/produse/Specialitati", icon: "🍤" },
  ],
};
